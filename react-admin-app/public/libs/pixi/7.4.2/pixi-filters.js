...
`
	const V = class extends a.Filter {
		constructor(t) {
			...
			const { kernels: r, blur: i, quality: o, pixelSize: s, resolution: n } = e
...
`
	const G = class extends a.Filter {
		constructor(t) {
			super(Ke, We), (this.uniforms.dimensions = new Float32Array(2)), Object.assign(this, G.defaults, t)
		}
		apply(t, e, r, i) {
			const { width: o, height: s } = e.filterFrame
			;(this.uniforms.dimensions[0] = o), (this.uniforms.dimensions[1] = s), t.applyFilter(this, e, r, i)
		}
		get radius() {
...
`,
	...
	_.parse = (function () {
		...
		function n(c, d, m) {
			return l(d, function (C) {
				var we = m()
				return (
					we && (y(t.comma) || r('Missing comma before color stops')), { type: c, orientation: we, colorStops: w(Vr) }
				)
			})
		}
		function l(c, d) {
		...
		function S() {
			var c,
				d = g(),
				m
			return d && ((c = []), c.push(d), (m = e), y(t.comma) && ((d = g()), d ? c.push(d) : (e = m))), c
		}
		function g() {
			var c = x() || Ir()
			if (c) c.at = Se()
		...
		function w(c) {
			var d = c(),
				m = []
			if (d) for (m.push(d); y(t.comma); ) (d = c()), d ? m.push(d) : r('One extra comma')
			return m
		}
		function Vr() {
			var c = Nr()
		...
		function y(c) {
			var d, m
			return (m = /^[\n\r\t\s]+/.exec(e)), m && ze(m[0].length), (d = c.exec(e)), d && ze(d[0].length), d
		}
		function ze(c) {
			e = e.substr(c)
		}
	...
	function He(t) {
		...
		if (typeof t == 'string')
			if (X[t]) (r = X[t].slice()), (o = 'rgb')
				...
				;(i = 1),
					l
						? ((r = [parseInt(s[0] + s[0], 16), parseInt(s[1] + s[1], 16), parseInt(s[2] + s[2], 16)]),
							n === 4 && (i = parseInt(s[3] + s[3], 16) / 255))
						: ((r = [parseInt(s[0] + s[1], 16), parseInt(s[2] + s[3], 16), parseInt(s[4] + s[5], 16)]),
				...
				;(r = e[2]
					...
					.map(function (g, x) {
						if (/%$/.test(g))
							return x === n ? parseFloat(g) / 100 : s === 'rgb' ? (parseFloat(g) * 255) / 100 : parseFloat(g)
						if (s[x] === 'h') {
			...
			isNaN(t)
				? Array.isArray(t) || t.length
					? ((r = [t[0], t[1], t[2]]), (o = 'rgb'), (i = t.length === 4 ? t[3] : 1))
					: t instanceof Object &&
						(t.r != null || t.red != null || t.R != null
							? ((o = 'rgb'), (r = [t.r || t.red || t.R || 0, t.g || t.green || t.G || 0, t.b || t.blue || t.B || 0]))
							: ((o = 'hsl'),
								(r = [
									t.h || t.hue || t.H || 0,
	...
	var M = { name: 'rgb', min: [0, 0, 0], max: [255, 255, 255], channel: ['red', 'green', 'blue'], alias: ['RGB'] },
		D = {
			name: 'hsl',
			min: [0, 0, 0],
			max: [360, 100, 100],
			...
			rgb: function (t) {
				...
				i < 0.5 ? (s = i * (1 + r)) : (s = i + r - i * r), (o = 2 * i - s), (l = [0, 0, 0])
				for (var h = 0; h < 3; h++)
					(n = e + (1 / 3) * -(h - 1)),
						n < 0 ? n++ : n > 1 && n--,
						6 * n < 1
	...
	function st(t) {
		...
		const r = (o) => {
			for (let s = o; s < e.length; s++) if (e[s] !== -1) return { indexDelta: s - o, offset: e[s] }
	...
	var ct = Object.defineProperty,
		...
		Y = (t, e, r) => (e in t ? ct(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : (t[e] = r)),
		k = (t, e) => {
	...
	const F = class extends a.Filter {
		constructor(t) {
			...
			super(Ue, Ye), (this._stops = []), (this.autoFit = !1), Object.assign(this, i)
		}
		get stops() {
			return this._stops
		}
...
void main() {
	...
	class yt extends a.Filter {
		...
		set nearest(e) {
			;(this._nearest = e), (this._scaleMode = e ? a.SCALE_MODES.NEAREST : a.SCALE_MODES.LINEAR)
	...
	class bt extends a.Filter {
		...
		set color(e) {
			...
			typeof e == 'number'
				...
				: ((r[0] = e[0]), (r[1] = e[1]), (r[2] = e[2]), (this._color = a.utils.rgb2hex(r)))
		}
		get color() {
			return this._color
		}
	...
	class Ft extends a.Filter {
		...
		set originalColor(e) {
			...
			typeof e == 'number'
				...
				: ((r[0] = e[0]), (r[1] = e[1]), (r[2] = e[2]), (this._originalColor = a.utils.rgb2hex(r)))
		}
		get originalColor() {
		...
		set newColor(e) {
			...
			typeof e == 'number'
				...
				: ((r[0] = e[0]), (r[1] = e[1]), (r[2] = e[2]), (this._newColor = a.utils.rgb2hex(r)))
		}
		get newColor() {
...
void main(void){
    ...
    gl_FragColor = sample;
		...
		J = (t, e, r) => (e in t ? Lt(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : (t[e] = r)),
		ee = (t, e) => {
	...
	const O = class extends a.Filter {
		constructor(t) {
			super(), (this.angle = 45), (this._distance = 5), (this._resolution = a.settings.FILTER_RESOLUTION)
			...
			;(this._offset = new a.ObservablePoint(this._updatePadding, this)),
				...
				(this.pixelSize = s),
				(this.resolution = n)
			const { shadowOnly: l, rotation: u, distance: h, offset: p, alpha: S, color: g } = e
			;(this.shadowOnly = l),
				u !== void 0 && h !== void 0 ? ((this.rotation = u), (this.distance = h)) : (this.offset = p),
				(this.alpha = S),
				(this.color = g)
		}
		apply(t, e, r, i) {
		...
		set distance(t) {
			a.utils.deprecation('5.3.0', 'DropShadowFilter distance is deprecated, use offset'),
				(this._distance = t),
				this._updatePadding(),
				this._updateShift()
		}
		...
		set rotation(t) {
			a.utils.deprecation('5.3.0', 'DropShadowFilter rotation is deprecated, use offset'),
	...
	const R = class extends a.Filter {
		constructor(t) {
			super(qt, Kt),
				...
				(this.texture = a.Texture.from(this._canvas, { scaleMode: a.SCALE_MODES.NEAREST })),
		...
		redraw() {
			...
			for (let s = 0; s < this._slices; s++) {
				...
				const n = this._sizes[s] * t,
					l = i > 0 ? i : 0,
					u = i < 0 ? -i : 0
				;(r.fillStyle = `rgba(${l}, ${u}, 0, 1)`), r.fillRect(0, o >> 0, t, (n + 1) >> 0), (o += n)
			}
	...
	const re = class extends a.Filter {
		constructor(t) {
			const e = Object.assign({}, re.defaults, t),
				{ outerStrength: r, innerStrength: i, color: o, knockout: s, quality: n, alpha: l } = e,
				u = Math.round(e.distance)
			super(
				Wt,
				Yt.replace(/__ANGLE_STEP_SIZE__/gi, `${(1 / n / u).toFixed(7)}`).replace(/__DIST__/gi, `${u.toFixed(0)}.0`)
			),
				(this.uniforms.glowColor = new Float32Array([0, 0, 0, 1])),
				(this.uniforms.alpha = 1),
				Object.assign(this, { color: o, outerStrength: r, innerStrength: i, padding: u, knockout: s, alpha: l })
		}
		get color() {
...
`
	...
	let se = oe
	se.defaults = { angle: 30, gain: 0.5, lacunarity: 2.5, time: 0, parallel: !0, center: [0, 0], alpha: 1 }
	var Qt = `attribute vec2 aVertexPosition;
attribute vec2 aTextureCoord;
...
`
	class sr extends a.Filter {
		...
		apply(e, r, i, o) {
			...
			;(this.uniforms.uKernelSize = s !== 0 || n !== 0 ? this.kernelSize : 0), e.applyFilter(this, r, i, o)
		}
		set velocity(e) {
			this.setVelocity(e)
		}
	...
	class lr extends a.Filter {
		...
		set replacements(e) {
			...
			for (let s = 0; s < o; s++) {
				const n = e[s]
				let l = n[0]
				typeof l == 'number' ? (l = a.utils.hex2rgb(l)) : (n[0] = a.utils.rgb2hex(l)),
					(r[s * 3] = l[0]),
					(r[s * 3 + 1] = l[1]),
					(r[s * 3 + 2] = l[2])
				let u = n[1]
				typeof u == 'number' ? (u = a.utils.hex2rgb(u)) : (n[1] = a.utils.rgb2hex(u)),
					(i[s * 3] = u[0]),
					(i[s * 3 + 1] = u[1]),
					(i[s * 3 + 2] = u[2])
			}
...
`
	const le = class extends a.Filter {
		...
		apply(t, e, r, i) {
			var o, s
			;(this.uniforms.dimensions[0] = (o = e.filterFrame) == null ? void 0 : o.width),
				(this.uniforms.dimensions[1] = (s = e.filterFrame) == null ? void 0 : s.height),
				(this.uniforms.seed = this.seed),
				t.applyFilter(this, e, r, i)
		}
		set sepia(t) {
	...
	const z = class extends a.Filter {
		constructor(t = 1, e = 0, r = 0.1, i = 1, o = !1) {
			super(fr, dr.replace(/\$\{angleStep\}/, z.getAngleStep(r))),
				...
				Object.assign(this, { thickness: t, color: e, quality: r, alpha: i, knockout: o })
		}
...
`
	class xr extends a.Filter {
		constructor(e = 0, r = [0, 0], i = 5, o = -1) {
			super(vr, pr), (this._angle = 0), (this.angle = e), (this.center = r), (this.kernelSize = i), (this.radius = o)
		}
		apply(e, r, i, o) {
			;(this.uniforms.uKernelSize = this._angle !== 0 ? this.kernelSize : 0), e.applyFilter(this, r, i, o)
		}
		set angle(e) {
...
`
	...
	let fe = ce
	fe.defaults = { mirror: !0, boundary: 0.5, amplitude: [0, 20], waveLength: [30, 100], alpha: [1, 1], time: 0 }
...
`
	const de = class extends a.Filter {
		constructor(t = [0, 0], e, r = 0) {
			super(Tr, Fr), (this.center = t), Object.assign(this, de.defaults, e), (this.time = r)
		}
		apply(t, e, r, i) {
	...
	let he = de
	he.defaults = { amplitude: 30, wavelength: 160, brightness: 1, speed: 500, radius: -1 }
	var Ar = `attribute vec2 aVertexPosition;
attribute vec2 aTextureCoord;
...
`
	class wr extends a.Filter {
		...
		apply(e, r, i, o) {
			var s, n
			;(this.uniforms.dimensions[0] = (s = r.filterFrame) == null ? void 0 : s.width),
				(this.uniforms.dimensions[1] = (n = r.filterFrame) == null ? void 0 : n.height),
				e.applyFilter(this, r, i, o)
		}
		get texture() {
		...
		set color(e) {
			...
			typeof e == 'number'
				? (a.utils.hex2rgb(e, r), (this._color = e))
				: ((r[0] = e[0]), (r[1] = e[1]), (r[2] = e[2]), (r[3] = e[3]), (this._color = a.utils.rgb2hex(r)))
		}
		get color() {
			return this._color
		}
...
`
	class E extends a.Filter {
		constructor(e) {
			...
			super(Pr, Mr),
				...
				(this.uniforms.start = (r = e.start) != null ? r : new a.Point(0, window.innerHeight / 2)),
				(this.uniforms.end = (i = e.end) != null ? i : new a.Point(600, window.innerHeight / 2)),
				(this.uniforms.delta = new a.Point(30, 30)),
				(this.uniforms.texSize = new a.Point(window.innerWidth, window.innerHeight)),
				this.updateDelta()
		}
		updateDelta() {
	...
	const ve = class extends a.Filter {
		constructor(t, e, r, i) {
			super(),
				typeof t == 'number' &&
					(a.utils.deprecation('5.3.0', 'TiltShiftFilter constructor arguments is deprecated, use options.'),
		...
		apply(t, e, r, i) {
			const o = t.getFilterTexture()
			this.tiltShiftXFilter.apply(t, e, o, 1), this.tiltShiftYFilter.apply(t, o, r, i), t.returnFilterTexture(o)
		}
		get blur() {
...
`,
		...
		jr = (t, e) => {
			...
			if (t != null && Ce) for (var i of Ce(t)) e.indexOf(i) < 0 && Er.call(t, i) && (r[i] = t[i])
			return r
		}
	const _e = class extends a.Filter {
		constructor(t) {
			...
			super(Or, Rr.replace('${maxKernelSize}', r.toFixed(1))), Object.assign(this, i)
		}
		get center() {
			return this.uniforms.uCenter
		}
	...
	let be = _e
	return (
		(be.defaults = { strength: 0.1, center: [0, 0], innerRadius: 0, radius: -1, maxKernelSize: 32 }),
